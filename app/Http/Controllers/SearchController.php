...
class SearchController extends Controller
{
    ...
    public function adminSearch(Request $request) {
        ...
        // keyword in product name
        $resultProducts_1 = Post::type('product')->where('post_title', 'like', '%'.$keyword.'%')->get();
        // keyword in product description
        $resultProducts_2 = Post::type('product')->where('post_content', 'like', '%'.$keyword.'%')->get();
        ...
        return view('admin.result', ['keyword' => $keyword, 'products_1' => $resultProducts_1, 'products_2' => $resultProducts_2, 'orders' => $orders]);
    }
}
