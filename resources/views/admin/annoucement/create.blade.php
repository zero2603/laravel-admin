...
<div class="row">
	<div class="col-lg-12">
		<form action="{{action('AnnoucementController@store')}}" method="POST">
			{{ csrf_field() }}
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" name="vie_title"/>
			</div>

			<div class="form-group">
				<label for="eng_content">English Content</label>
				<textarea rows="5" class="form-control" name="eng_content"></textarea>
			</div>

			<div class="form-group">
				<label for="vie_content">Vietnamese Content</label>
				<textarea rows="5" class="form-control" name="vie_content"></textarea>
			</div>
