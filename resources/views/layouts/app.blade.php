...
<head>
    ...
    <script type="text/javascript" src="{{ asset('public/master/BootstrapFormHelpers-master/dist/js/bootstrap-formhelpers.js') }}"></script>
    <script type="text/javascript" src="{{ asset('public/master/BootstrapFormHelpers-master/dist/js/bootstrap-formhelpers.min.js') }}"></script>
